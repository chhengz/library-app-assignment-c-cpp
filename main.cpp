...
int main()
{
	...
	do
	{
		...
		case '1':
		{
			...
			do
			{
				...
				case '2':
				{
					...
					gotoxy(46, 2); cout << "[ OUTPUT BOOK INFORMATION ]";
					objB->show_book_list();
					getch();
				}
				break;
				case '3':
				{
					...
					gotoxy(46, 1); cout << "[ SEARCH BOOK INFORMATION ]";
					objB->searchBook();
					getch();
				}
				break;
				case '4':
				{
					...
					clrscr();
					drawBoxSingleLine(44, 0, 31, 1);
					gotoxy(46, 1); cout << "[ DELETE BOOK INFORMATION ]";
					do
					{
		...
		case '2':
		{
			...
			do
			{
				...
				case '1':
				{
					...
					gotoxy(47, 3); cout << "[ INPUT READER INFORMATION ]";
					drawBoxSingleLine(23, 5, 10, 1, 1);
					foreColor(2); gotoxy(5, 6); cout << "Number of Readers";
					foreColor(6); gotoxy(24, 6); cin >> w; cout << endl;
					for (i = r; i < w + r; i++)
					{
						index++;
						foreColor(3); cout << "\n\t[No. -" << index << "-]" << endl;
				...
				case '2':
				{
					...
					gotoxy(46, 1); cout << "[ OUTPUT READER INFORMATION ]";
				...
				case '3':
				{
					...
					gotoxy(44, 1); cout << "[ SEARCH READER INFORMATION ]";
					objR->searchReader();
					getch();
				}
				break;
				case '4':
				{
					...
					clrscr();
					drawBoxSingleLine(44, 0, 31, 1);
					gotoxy(46, 1); cout << "[ SORT READER INFORMATION ]";
					do
					{
				...
				case '5':
				{
					clrscr();
					drawBoxSingleLine(44, 0, 31, 1);
					gotoxy(46, 1); cout << "[ DELETE READER INFORMATION ]";
					objR->updateReader();
					getch();
				}
				break;
		...
		case '3':
		{
			...
			do
			{
				...
				case '1':
				{
					...
					foreColor(6); gotoxy(26, 6); cin >> p; cout << endl;
					for (i = bw; i < bw + p; i++)
					{
						index++;
						foreColor(3); cout << "\n\t[No. -" << index << "-]" << endl;
				...
				{
					clrscr();
					foreColor(8); drawBoxSingleLine(43, 0, 34, 1);
					gotoxy(45, 1); cout << "[ OUTPUT BORROWER INFORMATION ]";
				...
				case '3':
				{
					clrscr();
					foreColor(8); drawBoxSingleLine(43, 0, 34, 1);
					gotoxy(45, 1); cout << "[ SEARCH BORROWER INFORMATION ]";
					objBR->searchBorrower();
					getch();
				}
				break;
				case '4':
		...
		break;
		default:
			gotoxy(36 + 12, 11); cout << "WRONG CASE!" << (char)3;
			getch();
			break;
		}
	} while (op != '0');
